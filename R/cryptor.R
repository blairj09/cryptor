#' cryptor: An R wrapper for the \href{https://www.cryptocompare.com}{CryptoCompare} API.
#'
...
#' call \href{https://min-api.cryptocompare.com/stats/rate/hour/limit}{hourly} and
#' \href{https://min-api.cryptocompare.com/stats/rate/second/limit}{second} limits.
#'
#' @section Functions:
#' \itemize{
